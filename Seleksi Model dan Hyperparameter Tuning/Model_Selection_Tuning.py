...
# Split the data into training and testing sets using parameter test_size = 0.2, random_state = 42
...
grid_search = GridSearchCV(LogisticRegression(random_state=42, max_iter=500), param_grid, cv=5)
